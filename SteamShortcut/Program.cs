...
internal static class Program
{
    ...
    {
        ShortcutContextMenu shortcutContextMenu = Container.GetRequiredService<ShortcutContextMenu>();
    ...
    private static void LogUnhandledExceptions(object sender, UnhandledExceptionEventArgs e)
    {
        ...
        MessageBox.Show((e.ExceptionObject as Exception)?.Message, "Fatal Error", MessageBoxButtons.OK,
