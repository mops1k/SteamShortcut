...
public class ShortcutEntry
{
    ...
    public VDFMap Raw { get; }

    public uint AppId
    {
        get => ReadInt("appid");
        set => WriteInt("appid", value);
    }
    ...
    {
        get => ReadString("StartDir");
        set => WriteString("StartDir", value);
    }

    public string? Icon
    {
        get => ReadString("icon");
        set => WriteString("icon", value);
    }

    public string? ShortcutPath
    {
        get => ReadString("ShortcutPath");
        set => WriteString("ShortcutPath", value);
    }

    public string? LaunchOptions
    {
        get => ReadString("LaunchOptions");
        set => WriteString("LaunchOptions", value);
    }

    public uint IsHidden
    {
        get => ReadInt("IsHidden");
        set => WriteInt("IsHidden", value);
    }

    public uint AllowDesktopConfig
    {
        get => ReadInt("AllowDesktopConfig");
        set => WriteInt("AllowDesktopConfig", value);
    }

    public uint AllowOverlay
    {
        get => ReadInt("AllowOverlay");
        set => WriteInt("AllowOverlay", value);
    }
    ...
    {
        get => ReadInt("Devkit");
        set => WriteInt("Devkit", value);
    }

    public string? DevkitGameID
    {
        get => ReadString("DevkitGameID");
        set => WriteString("DevkitGameID", value);
    }

    public uint DevkitOverrideAppID
    {
        get => ReadInt("DevkitOverrideAppID");
        set => WriteInt("DevkitOverrideAppID", value);
    }

    public uint LastPlayTime
    {
        get => ReadInt("LastPlayTime");
        set => WriteInt("LastPlayTime", value);
    }
    ...
    public void SetTag(int idx, string? value) =>
        Raw.GetValue("tags").ToMap().GetValue(idx.ToString()).Text = value;

    public void AddTag(string? value) =>
        Raw.GetValue("tags").ToMap().Map.Add(GetTagsSize().ToString(), new VDFString(value));
